package com.mlallemant.waterplant.feature_plant_list.presentation.core.permission.component
...
import com.mlallemant.waterplant.feature_plant_list.presentation.util.Common
...
fun PermissionUI(
    ...
    permissionEvent: (PermissionEvent) -> Unit
) {
    ...
    if (permissionGranted) {
        ...
        permissionEvent(PermissionEvent.OnPermissionGranted)
        return
    }
    ...
    val launcher = rememberLauncherForActivityResult(
        ...
        if (isGranted) {
            ...
            // Permission Denied
            permissionEvent(PermissionEvent.OnPermissionDenied)
        }
    }
